                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="apellidop" type="text" class="form-control @error('apellidop') is-invalid @enderror"
                                        name="apellidop" value="{{ old('apellidop') }}" required autocomplete="apellidop" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="apellidom" type="text" class="form-control @error('apellidom') is-invalid @enderror"
                                        name="apellidom" value="{{ old('apellidom') }}" required autocomplete="apellidom" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="email"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Correo electronico E-Mail') }}</label>
